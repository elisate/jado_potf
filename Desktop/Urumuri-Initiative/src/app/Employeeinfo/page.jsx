...
export default function EmployeeForm() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-20 mb-10 bg-white shadow-lg rounded-xl p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded px-3 py-2 focus:ring-2 focus:ring-red-600"
            required
          />
        </div>
...
<div>
  ...
  />
        ...
        <div>
  <label className="block mb-1 font-medium text-gray-700">National ID *</label>
  <input
    type="text"
    name="NationalId"
    placeholder="e.g., 1199xxxxxxx"
